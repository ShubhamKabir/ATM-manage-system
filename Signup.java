...
public class Signup extends JFrame implements ActionListener{
    ...
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l1f;
    ...
    Signup(){
        ...
        l1f = new JLabel(String.valueOf(first));
        l1f.setFont(new Font("Raleway", Font.BOLD, 38));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if(t6.getText().equals("")){
                ...
                new Signup2(fr).setVisible(true);
                setVisible(false);
            }
