...
public class FastCash extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
            ...
            if(ae.getSource()==b1){
                    ...
                    if(rs.next()){
                        ...
                        balance-=100;
                        String q1= "update bank set deposit='"+null+"',withdraw='"+100+"',balance='"+balance+"' where pin='"+a+"'";
                    ...
                    if(rs.next()){
                        ...
                        balance-=500;
                        String q1= "update bank set deposit='"+null+"',withdraw='"+500+"',balance='"+balance+"' where pin='"+a+"'";
                    ...
                    if(rs.next()){
                        ...
                        balance-=1000;
                        String q1= "update bank set deposit='"+null+"',withdraw='"+1000+"',balance='"+balance+"' where pin='"+a+"'";
                    ...
                    if(rs.next()){
                        ...
                        balance-=2000;
                        String q1= "update bank set deposit='"+null+"',withdraw='"+2000+"',balance='"+balance+"' where pin='"+a+"'";
                    ...
                    if(rs.next()){
                        ...
                        balance-=5000;
                        String q1= "update bank set deposit='"+null+"',withdraw='"+5000+"',balance='"+balance+"' where pin='"+a+"'";
                    ...
                    if(rs.next()){
                        ...
                        balance-=10000;
                        String q1= "update bank set deposit='"+null+"',withdraw='"+10000+"',balance='"+balance+"' where pin='"+a+"'";
    ...
    public static void main(String[] args){
        String b=new String();
        new FastCash(b).setVisible(true);
    }
}