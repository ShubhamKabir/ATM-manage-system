...
public class Signup3 extends JFrame implements ActionListener{
        ...
        try{
            ...
            if(ae.getSource()==b1){
                ...
                if(b.equals("")){
                    ...
                    conn c1 = new conn();
                    String q1 = "insert into signup3 values('"+z+"','"+a+"','"+first8+"','"+first4+"','"+b+"')";  
                    ...
                    new Deposit(String.valueOf(first4)).setVisible(true);
                    setVisible(false);
                }
    ...
    public static void main(String[] args){
        ...
        new Signup3(fr).setVisible(true);
    }
