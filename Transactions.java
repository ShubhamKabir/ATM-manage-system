...
public class Transactions extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){ 
            ...
            new Deposit(myb).setVisible(true);
            setVisible(false);
            
        }
        else if(ae.getSource()==b2){ 
            
            new Withdrawl(myb).setVisible(true);
            setVisible(false);
            
        }
        else if(ae.getSource()==b3){ 
            
            new FastCash(myb).setVisible(true);
            setVisible(false);
            
        }else if(ae.getSource()==b4){ 
            
            JOptionPane.showMessageDialog(null,"Module in development");
            
        }else if(ae.getSource()==b5){ 
            
            new Pin(myb).setVisible(true);
            setVisible(false);
